...
export function SchoolMap({
  ...
  const locationIcon = useMemo(() => {
    ...
    // Your red pin SVG
    const svgIcon =
      '<svg xmlns="http://www.w3.org/2000/svg" width="40" height="50" viewBox="0 0 40 50"><path d="M20 0C9 0 0 9 0 20c0 11 20 30 20 30s20-19 20-30C40 9 31 0 20 0z" fill="#EA4335"/><circle cx="20" cy="20" r="8" fill="#FFFFFF"/></svg>';
    return {
